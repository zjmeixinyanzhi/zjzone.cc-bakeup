...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'panaroma' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'panaroma' ),
		'repeat-y'  => __( 'Repeat Vertically', 'panaroma' ),
		'repeat'    => __( 'Repeat All', 'panaroma' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'panaroma' ),
		'top center'    => __( 'Top Center', 'panaroma' ),
		'top right'     => __( 'Top Right', 'panaroma' ),
		'center left'   => __( 'Middle Left', 'panaroma' ),
		'center center' => __( 'Middle Center', 'panaroma' ),
		'center right'  => __( 'Middle Right', 'panaroma' ),
		'bottom left'   => __( 'Bottom Left', 'panaroma' ),
		'bottom center' => __( 'Bottom Center', 'panaroma' ),
		'bottom right'  => __( 'Bottom Right', 'panaroma')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'panaroma' ),
		'fixed'  => __( 'Fixed in Place', 'panaroma')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'panaroma' ),
		'italic'      => __( 'Italic', 'panaroma' ),
		'bold'        => __( 'Bold', 'panaroma' ),
		'bold italic' => __( 'Bold Italic', 'panaroma' )
		);
