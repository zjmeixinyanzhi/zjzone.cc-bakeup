 ...
 */
class Photo_Perfect_Heading_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Photo_Perfect_Message_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Photo_Perfect_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Photo_Perfect_Dropdown_Taxonomies_Control extends WP_Customize_Control {
