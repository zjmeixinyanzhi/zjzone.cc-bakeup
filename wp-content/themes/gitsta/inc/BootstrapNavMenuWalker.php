...
if( ! function_exists('gitsta_bootstrap_setup')):
    ...
    function gitsta_bootstrap_setup()
    {
        ...
        |----------------------------------------------------------
        | 
        | by Edward McIntyre <https://twitter.com/twittem>
        | with two little enhancements:
        |   - support for more icons (Octicons, Glyphicons and Font Awesome)
        |   - support for submenues (reported by Xaldeon <https://github.com/Xaldeon>)
        */
            ...
            public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
            {
                ...
                if (strcasecmp($item->attr_title, 'divider') == 0 && $depth === 1) {
                    ...
                    if (!empty($item->attr_title)) {
                        ...
                        // Get the family by the first piece of attr_title (e.g. fa-code -> font awesome family)
                        if(strstr($item->attr_title, '-')) {
                            $split  = explode('-', $item->attr_title);
                            $family = $split[0];
